...
//            wp_register_script('sweetalert2_js', SDS_OPTIONS_AND_SETTINGS__PLUGIN_URL . 'sweetalert2/sweetalert2.min.js',array ( 'jquery' ), 1.1, true);
            wp_register_script('sweetalert2_js', SDS_OPTIONS_AND_SETTINGS__PLUGIN_URL . 'sweetalert2/sweetalert2.min.js');
        }

//        dd( SDS_OPTIONS_AND_SETTINGS__PLUGIN_URL . 'sweetalert2/sweetalert2.min.js');
