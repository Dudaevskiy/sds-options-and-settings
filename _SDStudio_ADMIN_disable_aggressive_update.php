...
//enable_ADMIN_disable_aggressive_update-sds-options-and-settings

$redux = get_option( 'redux_sds_options_and_settings' );

$enable_ADMIN_disable_aggressive_update_sds_options_and_settings = $redux['enable_ADMIN_disable_aggressive_update-sds-options-and-settings'];

if ($enable_ADMIN_disable_aggressive_update_sds_options_and_settings == 1 ) {
    /**
     ...
     */
    if( is_admin() ){
//        dd($enable_ADMIN_disable_aggressive_update_sds_options_and_settings);
